  ...
  return (
    <div>
      ...
      <div class="py-1" style={{ fontFamily: "Inter", marginTop: "70px" }}>
        ...
        >
          <div
            className="lg:flex lg:-mx-4 mt-6 md:mt-12"
            style={{ margin: "auto" }}
          >
            <div class=" lg:w-1/3 my-4 md:my-6 ">
              ...
              >
                <div class="p-6 md:py-8">
                  <h4
                    className={`${styles["title-price"]} font-medium leading-tight text-2xl mb-2`}
                  >
                    Chinese Cuisine
                  </h4>
                ...
                <div class=" lg:w-1/3 my-4 md:my-6">
                  ...
                  >
                    <div class="p-6 md:py-8">
                      ...
                      <p class="text-gray-600">
                        Italian cuisine is characterized by its extreme
                  ...
                  <div class=" lg:w-1/3 my-4 md:my-6 ">
                    ...
                    >
                      <div class="p-6 md:py-8">
                        ...
                        <p class="text-gray-600">
                          Colombian cuisine is not a single cuisine but a
                          collection of differing regional cuisines; each is its
                          own distinct Colombian food.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class=" lg:w-1/3 my-4 md:my-6">
                    ...
                    >
                      <div class="p-6 md:py-8">
                        ...
                        <p class="text-gray-600">
                          Though more complex cuisines exist, none comes close
                          to matching Japan’s culinary aesthetics.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class=" lg:w-1/3 my-4 md:my-6">
                    ...
                    >
                      <div class="p-6 md:py-8">
                        ...
                        <p class="text-gray-600">
                          This cuisine is a Middle Eastern culinary marriage and
                          the nation has some of the most dedicated and talented
                          cooks.
                        </p>
                      </div>
                    </div>
