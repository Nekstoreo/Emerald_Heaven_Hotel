...
function Dining() {
  return (
    ...
    <div style={{textAlign: "justify", fontFamily: "Inter", fontSize: "18px", width: "60%", margin: "auto", marginTop: "10px"}}>
    ...
    <div class="py-1" style={{fontFamily: "Inter", marginTop: "70px"}}>
        ...
        >
        <div className="lg:flex lg:-mx-4 mt-6 md:mt-12" style={{ margin: "auto" }}>
            <div class=" lg:w-1/3 my-4 md:my-6 ">
            <div
                style={{border: "1px solid rgba(200, 200, 200, 0.712)", borderRadius: "9px"}}
                class=" border-t-4 border-solid border-white text-center max-w-sm mx-auto hover:border-indigo-600 transition-colors duration-300"
            >
                <div class="p-6 md:py-8">
                    <h4 class="title-price font-medium leading-tight text-2xl mb-2">
                        Chinese Cuisine
                    </h4>
                    <p class="text-gray-600">
                        The outside world defines as Chinese cuisine as not a true
                        cuisine but rather a composite of distinct regional
                        cuisines.
                    </p>
                </div>
            </div>
            ...
            <div
                style={{
                    border: "1px solid rgba(200, 200, 200, 0.712)",
                    borderRadius: "9px"
                }}
            ...
            >
                <div class="p-6 md:py-8">
                    ...
                    <p class="text-gray-600">
                        Overall, the cooking of France is the best in the Western
                        World. And its classical and regional cuisines are superb.
                    </p>
                </div>
            </div>
            <div class=" lg:w-1/3 my-4 md:my-6">
      ...
      <div class=" py-1" style={{fontFamily: "Inter"}}>
        <div
            class="container mx-auto"
            style={{paddingRight: "100px", paddingLeft: "100px"}}
        >
          <div class=" lg:flex lg:-mx-4 mt-6 md:mt-12" style={{ margin: "auto" }}>
            <div class=" lg:w-1/3 my-4 md:my-6 ">
              ...
              >
                <div class="p-6 md:py-8">
                  ...
                  <p class="text-gray-600">
                    Colombian cuisine is not a single cuisine but a collection
                    of differing regional cuisines; each is its own distinct
                    Colombian food.
                  </p>
                </div>
              </div>
              ...
              >
                <div class="p-6 md:py-8">
                  ...
                  <p class="text-gray-600">
                    ...
                    matching Japan’s culinary aesthetics.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
                <div class="p-6 md:py-8">
                    ...
                    <p class="text-gray-600">
                        This cuisine is a Middle Eastern culinary marriage and the
                        nation has some of the most dedicated and talented cooks.
                    </p>
                </div>
            </div>
          </div>
    ...
    <h1
        class="sec-head"
        style={{ textAlign: "center", marginTop: "100px", marginBottom: "60px" }}
    >
        Order Now
    </h1>
      <div class="big">
        <article class="recipe">
          ...
          <div class="recipe-content">
            ...
            <p class="recipe-desc">
              This pepperoni pan pizza is made with a simple yet superlative
              from-scratch tomato sauce, two types of mozzarella, Parmesan
              cheese, pepperoni, and either store-bought or homemade dough.
            </p>
            <br />
        ...
        <article class="recipe">
          ...
          <div class="recipe-content">
            ...
            <p class="recipe-desc">
              ...
              Italian dish made of stacked layers of lasagne alternating with
              fillings.
            </p>
            <br />
            <button class="recipe-save" type="button">
        ...
        <article class="recipe">
          ...
          <div class="recipe-content">
            ...
            <p class="recipe-desc">
              ...
              hand-sized corn or wheat tortilla topped with a filling. The
              tortilla is then folded around the filling and eaten by hand.
            </p>
            <br />
            <button class="recipe-save" type="button">
              <svg
