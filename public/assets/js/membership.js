...
// 		l.style.left = a.clientX + "px";
// 		l.style.top = a.clientY + "px";
// 		h.style.left = a.clientX + "px";
// 		h.style.top = a.clientY + "px";
// 		g.style.left = a.clientX + "px";
// 		g.style.top = a.clientY + "px";
// 	});
// 	var l = document.getElementById("cursor");
// 	var h = document.getElementById("cursor2");
// 	var g = document.getElementById("cursor3");
